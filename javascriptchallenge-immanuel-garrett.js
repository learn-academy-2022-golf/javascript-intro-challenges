...
console.log(`${theQuestion} is ${theAnswer}`);
...
// Write the code that will log whether theQuestion.length is greater than theAnswer.log
console.log(theQuestion.length > theAnswer.log);
console.log(theAnswer.log);
console.log(theQuestion.length > Math.log(theAnswer));
